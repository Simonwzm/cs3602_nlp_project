...
from load_data import load_ontonotes4ner,equip_chinese_ner_with_skip,load_yangjie_rich_pretrain_word_list,\
    load_resume_ner,load_weibo_ner,load_weibo_ner_old, load_slu
...
parser.add_argument('--dataset',default='slu',help='resume|ontonote|weibo|msra')
...
if args.dataset == 'slu':
    datasets,vocabs,embeddings = load_slu(slu_path,yangjie_rich_pretrain_unigram_path,yangjie_rich_pretrain_bigram_path,
                                                    _refresh=refresh_data,index_token=False,
                                                    )
if args.dataset == 'ontonote':
    args.batch = 10
...
fitlog.set_log_dir('logs/'+args.dataset+'_'+args.model+'_'+str(args.bi)+'_'+str(args.skip_before_head)+'_'+str(args.hidden)+'_'+str(args.lr)+'_'+str(args.batch)+'_'+str(args.embed_dropout)+'_'+str(args.output_dropout)+'_'+str(args.gaz_dropout))
...
loss = LossInForward()
encoding_type = 'bmeso'
if args.dataset == 'weibo' or args.dataset=='slu':
    encoding_type = 'bio'
